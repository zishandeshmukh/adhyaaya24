	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(app)/pg/check_status/_server.ts.js'))
			},
			{
				id: "/(app)/pg/[rid]/pay",
				pattern: /^\/pg\/([^/]+?)\/pay\/?$/,
